...
class BeerControllerTest {
    ...
    void testAddBeer() throws Exception {
        ...
        given(beerService.addBeer(any(BeerDTO.class))).willReturn(beerServiceImpl.listBeers(null, null).get(1));
    ...
    void testDeleteBeerById() throws Exception {
        BeerDTO beer = beerServiceImpl.listBeers(null, null).get(1);
...
//        ArgumentCaptor<UUID> uuidArgumentCaptor = ArgumentCaptor.forClass(UUID.class);
    ...
    @Test
    void testAddBeerWhenBeerNameIsNullOrBlank() throws Exception {
